...
const MainComponent = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://www.alphavantage.co/query?function=TOP_GAINERS_LOSERS&apikey=demo")
            ...
            .then((data) => { setData(data.top_gainers) })
    }, [])
    return (
                ...
                <nav>
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li><a className="dropdown-item" href=".">Stat </a></li>
                            <li><a className="dropdown-item" href=".">Community </a></li>
                            <li><a className="dropdown-item" href="."> Add Liquidity</a></li>
            ...
            <div className='component7-main-page'>
                <div className="container">
                    <div className='left'>
                        <p>BUY USDC ON </p>
                        <p>ALGORAND</p>
                        <div className=' maxc d-flex justify-content-start align-items-center'>
                            <h5>Powered by </h5>
                            <img src={Maxc} alt="" />
                        </div>
